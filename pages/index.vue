          ...
          <div class="col-12">
            <nav class="main-nav">
              ...
              <a href="#" class="logo" style="margin-top: 20px">
                <img
                  src="images/canalizados-logo.png"
                  alt=""
                  width="200"
                  height="30"
                />
              ...
              <ul class="nav">
                ...
                <li class="scroll-to-section">
                  <NuxtLink to="/iniciar-sesion" class="menu-item"
                    >Iniciar Sesion</NuxtLink
                  >
                </li>
                <li class="scroll-to-section">
                  <NuxtLink to="/registro" class="menu-item"
        ...
        <div class="container">
          <div class="row">
            ...
            >
              <h1
                class="main-title"
                style="font-family: 'Space Grotesk' !important"
              >
                El mejor medio digital para tu <em>START UP</em>
              </h1>
              <p>
          ...
          >
            <div class="features-item">
              <div class="features-icon">
                <h2>01</h2>
                <img
                  src="images/Add_apps_perspective_matte_s.png"
                  alt=""
                  style="
                    height: 100px;
                    width: 100px;
          ...
          >
            <div class="features-item">
              <div class="features-icon">
                <h2>02</h2>
                <img
                  src="images/User_perspective_matte_s.png"
                  alt=""
                  style="
                    height: 100px;
                    width: 100px;
          ...
          >
            <div class="features-item">
              <div class="features-icon">
                <h2>03</h2>
                <img
                  src="images/perspaleta2_0043.png"
                  alt=""
                  style="
                    height: 100px;
                    width: 100px;
                ...
                <p>
                  ¡Sube tu startup y revoluciona el mercado! Nosotros te
                  apoyaremos en lo que podamos
                </p>
    ...
    <section class="section" id="promotion">
      <div class="container">
        <div class="row">
          ...
          >
            <img
              src="images/2002.i039.010_chatbot_messenger_ai_isometric_set-09.jpg"
          ...
          >
            <ul>
              ...
              >
                <img
                  src="images/Chart_perspective_matte_s.png"
                  alt=""
                ...
                <div class="text">
                  <h4>Espacio</h4>
                  <p>
                    Nosotros te brindamos el espacio y el momento para poder
              ...
              >
                <img
                  src="images/Message_perspective_matte_s.png"
                  alt=""
                  height="100px"
                  width="100px"
                />
                <div class="text">
                  <h4>Gente</h4>
                  <p>
                    Te brindamos una comunidad de emprendedores en la cual
                    puedas reclutar gente o hacer amigos.
                  </p>
                </div>
              </li>
              <li
              ...
              >
                <img
                  src="images/FAQ_perspective_matte_s.png"
                  alt=""
                  height="100px"
                  width="100px"
                />
                <div class="text">
                  <h4>Informacion</h4>
                  <p>
                    Te brindamos una seccion de informacion sobre los startups
                    que mas destacan en el mundo.
                  </p>
                </div>
              </li>
            </ul>
        ...
        <div class="row">
          ...
          <div class="glider-contain">
            ...
            <button aria-label="Previous" class="glider-prev">
              <i class="fas fa-chevron-left icono-main"></i>
            </button>
            <button aria-label="Next" class="glider-next">
              <i class="fas fa-chevron-right icono-main"></i>
            </button>
