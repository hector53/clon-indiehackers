            ...
            <b-col lg="4">
              <LazyHydrate when-visible>
                <div class="div-block-448">
                  <follow-seccion
                    :p="p"
                    :avatar="arrayPost[0].avatar"
                    :username="arrayPost[0].username"
                  ></follow-seccion>
...
export default {
  ...
  async asyncData({ params, store, redirect, app }) {
    const seoDetails = await app.$axios.$get(
      "https://acceso.canalizados.com/api/getpost/usuario/?slug=" +
        params.slug +
        "&token=" +
    ...
    if (seoDetails.status == 0) {
      ...
      if (imagenSeo == "") {
        imagenSeo =
          "https://e54k7o.infiniteuploads.cloud/2021/06/portadacanalizados.jpg";
      }
      ...
      metaArray.push(
        ...
        },
        {
          hid: "og:url",
          property: "og:url",
          content: "https://canalizados.com/c/" + params.slug
        },
        {
          hid: "og:site_name",
        ...
        },
        {
          hid: "twitter:data1",
          name: "twitter:data1",
          content: seoDetails.post[0].username
        },
        {
          hid: "twitter:title",
          name: "twitter:title",
      ...
      return {
        SeoPost: metaArray,
        tituloSeo: seoDetails.post[0].titulo,
        arrayPost: seoDetails.post,
        p: seoDetails.post[0].p,
        idP: seoDetails.post[0].id,
        votos: seoDetails.post[0].votos,
        favPost: seoDetails.post[0].fav,
        cantidadComentarios: seoDetails.post[0].cantCommentarios,
        previewUrl: seoDetails.previewUrl,
        idE: seoDetails.post[0].idE,
        status: 1,
        audio: seoDetails.post[0].audio,
        audioActivo: seoDetails.post[0].audioActivo
      };
    }
  },
