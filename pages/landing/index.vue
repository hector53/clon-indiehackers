            ...
            <div class="container">
                <div class="row">
                    <div class="left-text col-lg-6 col-md-12 col-sm-12 col-xs-12"
                        ...
                        <h1>El mejor medio digital para tu <em>START UP</em></h1>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="center-heading">
                        ...
                        <p>"La fuente del éxito es escuchar la opinión del resto, siempre siendo cuidadosos". ~ Pepe Suarez</p>
                    </div>
                </div>
                    ...
                    <div class="owl-carousel owl-theme">
                        <div class="item service-item">
                            ...
                            <div class="testimonial-content">
                                ...
                                <h4>Pepe Suarez</h4>
                                <p>“Al principio no estaba seguro si Canalizados podia hacer triunfar mi start up, pero asi fue”</p>
                                <span>Toptal CTO</span>
                            </div>
                        </div>
                        <div class="item service-item">
                            <div class="author">
                            ...
                            <div class="testimonial-content">
                                ...
                                <h4>Ramon Rodriguez</h4>
                                <p>“Estoy orgulloso de decir que mi start up logro triunfar gracias a Canalizados”</p>
